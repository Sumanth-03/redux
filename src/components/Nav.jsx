    ...
    return(
        <nav className="fixed top-0  p-4 m-0 bg-slate-200 w-screen flex flex-row justify-end items-center ">
            ...
            {isLoggedIn &&
                ...
                <NavLink to='/form_1' className='px-5 p-2 rounded-xl hover:bg-gray-100 shadow-inner'>Form_1</NavLink>
                <NavLink to='/form_2' className='px-5 p-2 rounded-xl hover:bg-gray-100 shadow-inner'>Form_2</NavLink>
